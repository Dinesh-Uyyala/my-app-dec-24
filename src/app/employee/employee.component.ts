...
export class EmployeeComponent {
  ...
  employees: any = [
    ...
    { name: 'raj', experience: 4, package: 1600000, role: 'UIDeveloper' },
    { name: 'sunil', experience: 5, package: 1200000, role: 'UIDeveloper' },
    { name: 'latha', experience: 2, package: 600000, role: 'Software Developer' },
    { name: 'rama', experience: 5, package: 1400000, role: 'Software Developer' },
    { name: 'smitha', experience: 4, package: 1600000, role: 'Data engineer' },
